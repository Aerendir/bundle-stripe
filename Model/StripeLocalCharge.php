...
class StripeLocalCharge implements StripeLocalResourceInterface
{
    ...
    /**
     * @var  string $description optional, default is null.
     *
    ...
    /**
     * @var StripeLocalCard $source For most Stripe users, the source of every charge is a credit or debit card.
